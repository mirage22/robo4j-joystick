 ...
 * This FrontHandUnit.java is part of Robo4j and robo4j-joystick
 *
...
package com.robo4j.demo.joystick.unit;
...
public class FrontHandUnit extends DefaultUnit implements LegoUnit {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FrontHandUnit.class);
    /* all connected pars  */
    ...
    protected   Map<RoboUnitCommand, Function<ProcessAgent, AgentStatus>> initLogic(){
        ...
        logger.info("INIT FRONTHAND LOGIC");
        result.put(FrontHandCommandEnum.COMMAND, (ProcessAgent agent) -> {
            ...
            try {
                ...
                throw new FrontHandException("ERROR CYCLE COMMAND= ", e);
            }
        ...
        result.put(FrontHandCommandEnum.EXIT, (ProcessAgent agent) -> {
            ...
            try {
                ...
                throw new FrontHandException("ERROR PROCESS: ", e);
            }
